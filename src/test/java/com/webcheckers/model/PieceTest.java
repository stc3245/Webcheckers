...
public class PieceTest
{
    ...
    {
        Piece p = new Piece(Piece.PieceEnum.SINGLE, Piece.ColorEnum.RED);
        assertEquals(p.getType(), Piece.PieceEnum.SINGLE);
    }
    ...
    public void testGetColor()
    {
        ...
        p = new Piece(Piece.PieceEnum.SINGLE, Piece.ColorEnum.WHITE);
    ...
    public void testHashAndEquals()
    {
        ...
        Piece same = new Piece(Piece.PieceEnum.SINGLE, Piece.ColorEnum.RED);
